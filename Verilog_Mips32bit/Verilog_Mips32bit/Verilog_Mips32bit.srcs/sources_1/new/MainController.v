...
module MainController(
    ...
    assign oALUSrcB = {(c_state == S_Decode | c_state == S_MemAdr | c_state == S_ADDIExcute), (c_state == S_Fetch | c_state == S_Decode | c_state == S_Branch)};
    ...
    assign oIRWrite = (c_state == S_Fetch);   // to Register Enables
    assign oMemWrite = (c_state == S_MemWrite);
    assign oPCWrite = (c_state == S_Jump || c_state == S_Fetch);
